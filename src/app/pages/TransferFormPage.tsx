...
import { Transfer, TransferItem } from "../types/inventory";
...
export default function TransferFormPage() {
  ...
  useEffect(() => {
    if (isEdit && id) {
      ...
      if (transfer) {
        ...
        setFromWarehouseName(transfer.fromWarehouse);
        setToWarehouseName(transfer.toWarehouse);
      } else {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.fromWarehouse || !formData.toWarehouse || !formData.fromLocation || !formData.toLocation) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setFormData({ ...formData, fromWarehouse: e.target.value, fromLocation: "" });
                  }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                  required
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    setToWarehouseName(e.target.value);
                    setFormData({ ...formData, toWarehouse: e.target.value, toLocation: "" });
                  }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                  required
                >
